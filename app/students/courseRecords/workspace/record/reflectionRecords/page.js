...
function page() {
  ...
  return (
    <>
      <div className="flex flex-col flex-grow w-full h-screen text-xl justify-start items-center px-8 gap-2">
        <div
          id="contents"
      ...
      >
        <button
          ...
          onClick={() => {
            router.push(
              `/students/courseRecords/workspace/preview/reflectionRecords?id=${_id}&teacher_id=${teacher_id}`
            );
          }}
        >
          提交
